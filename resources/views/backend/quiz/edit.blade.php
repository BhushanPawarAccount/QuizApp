        ...
        <div class="content">
            ...
            <div class="module">
                ...
                <div class="module-body">
                        ...
                        <form class="" method="POST" action="{{route('quiz.update',[$quiz->id])}}">
                            @csrf
                            {{method_field('PUT')}}
                            <div class="control-group">
                                <label class="control-label" for="name">Quiz name</label>
                                <div class="controls">
                                    <input type="text" name="name" id="name" placeholder="Name of quiz" value="{{$quiz->name}}" class="span8">
                                ...
                                <div class="controls">
                                    <textarea name="description" id="description" placeholder="Enter quiz description" rows="5"  class="span8">{{$quiz->description}}</textarea>
                                ...
                                <div class="controls">
                                    <input type="text" name="minutes" id="minutes" placeholder="Quiz minutes" value="{{$quiz->minutes}}" class="span8">
